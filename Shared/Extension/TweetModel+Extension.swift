...
extension Sweet.TweetModel {
    ...
    let publicMetics = try? decoder.decode(Sweet.TweetPublicMetrics.self, from: tweet.publicMetrics ?? emptyData)
    ...
    let promotedMetrics = try? decoder.decode(Sweet.PromotedMetrics.self, from: tweet.promotedMetrics ?? emptyData)
