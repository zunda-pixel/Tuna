...
@MainActor final class SearchViewModel<T: SearchTweetsViewModel>: NSObject, SearchViewProtocol {
  var searchUserIDs: [String] = []
  var tweetsViewModel: T
  var searchText: String = ""

  init(tweetsViewModel: T) {
...
final class SearchTweetsViewModel: NSObject, TweetsViewProtocol {
  var searchText: String = ""
  ...
  func fetchTweets(first firstTweetID: String?, last lastTweetID: String?) async {
    ...
    do {
      let response = try await Sweet().searchRecentTweet(by: searchText, nextToken: paginationToken)
