...
extension Sweet.UserModel {
  init(user: User) {
    ...
    self.init(
      ...
      profileImageURL: user.profileImageURL, description: user.descriptions,
      protected: user.protected, url: user.url, createdAt: user.createdAt, location: user.location,
      pinnedTweetID: user.pinnedTweetID, metrics: metrics, withheld: withheld, entity: entity)
  }
}
